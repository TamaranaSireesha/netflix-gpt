...
const Login = () => {
 ...
 signInWithEmailAndPassword(auth,email.current.value,password.current.value)
  ...
  return (
    ...
    <form onSubmit={(e)=>email.prevent.default} className="bg-black p-12 absolute  w-3/12  mx-auto my-36 right-0 left-0 bg-opacity-80 rounded-md text-white" onClick={HandleValidation}>
     ...
     <input type="password" placeholder='password' className="p-3 my-3 w-full  bg-gray-700 " ref={password}/>
